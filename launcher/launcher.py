...
console_formatter = logging.Formatter('%(asctime)s:%(levelname)s:[1;36mlauncher[0m:%(message)s')
...
class Launcher(ctk.CTk):
    def __init__(self, java_path, config):
        ...
        try:
            ...
            # Modpack Version
            self.version_frame = ctk.CTkFrame(self.main_frame, fg_color="#2B2B2B")
            self.version_frame.pack(pady=(0,8), fill="x")
            self.vf_left = ctk.CTkFrame(self.version_frame, width=108, height=3, corner_radius=9, fg_color="#ffc0cb" )
            self.vf_left.pack(side="left", padx=26)
            self.version_label = ctk.CTkLabel(self.version_frame, text="Modpack: ...", font=("Verdana", 14), text_color="#ffc0cb")
            self.version_label.pack(side="left", expand="true")
            self.vf_right = ctk.CTkFrame(self.version_frame, width=108, height=3, corner_radius=9, fg_color="#ffc0cb" )
            self.vf_right.pack(side="right", padx=26)
            ...
            self.color_preview.pack(side="left", padx=(0, 56))
            ...
            self.author_label = ctk.CTkLabel(self.main_frame, text=f"launcher: v{LAUNCHER_VER} by chromaetheral", font=("Verdana", 12), text_color="#5E5657")
            self.author_label.pack(pady=8)
